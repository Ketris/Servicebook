...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_validate($_POST['_csrf_token'] ?? null)) {
        ...
        try {
            ...
            $phoneRegion = strtoupper(trim((string)($_POST['phone_region'] ?? 'US')));
            $settings['phone_region'] = in_array($phoneRegion, $allowedPhoneRegions, true) ? $phoneRegion : 'US';
