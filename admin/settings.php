...
$allowedPhoneRegions = ['US/CAN', 'Europe', 'Asia', 'Other'];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_validate($_POST['_csrf_token'] ?? null)) {
        ...
        try {
            ...
            $phoneRegion = trim((string)($_POST['phone_region'] ?? 'US/CAN'));
            $settings['phone_region'] = in_array($phoneRegion, $allowedPhoneRegions, true) ? $phoneRegion : 'US/CAN';
