        ...
        <form method="post" novalidate id="edit-call-form">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input id="city" name="city" class="form-control" type="text" value="<?= escape($values['city']) ?>" maxlength="150" <?= $isTechnician && !$canEditDetails ? 'disabled' : '' ?>>
                ...
                <div class="col-md-4">
                    ...
                    <input id="phone" name="phone" class="form-control" type="text" autocomplete="off" value="<?= escape($values['phone']) ?>" maxlength="100" <?= $isTechnician && !$canEditDetails ? 'disabled' : '' ?>>
                ...
                <div class="col-md-4">
                    ...
                    <input id="email" name="email" class="form-control" type="email" autocomplete="off" value="<?= escape($values['email']) ?>" maxlength="255" <?= $isTechnician && !$canEditDetails ? 'disabled' : '' ?>>
                ...
                <div class="col-12">
                    ...
                    <input id="po_number" name="po_number" class="form-control" type="text" autocomplete="off" value="<?= escape($values['po_number']) ?>" maxlength="100" <?= $isTechnician && !$canEditDetails ? 'disabled' : '' ?>>
